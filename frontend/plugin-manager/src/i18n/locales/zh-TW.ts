  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        introBasic: '這裡有一個神奇按鈕！只要點擊它，就可以直接和我聊天啦！想跟我分享今天的新鮮事嗎？或者只是叫叫我的名字？快來試試嘛，我已經迫不及待想聽到你的聲音啦！喵！',
        ...
        takeoverSettingsPeekDetail: '你看，這裡可以穿我的新衣服、給我換一個好聽的聲音……換一個貓娘，或是修改記憶？等一下！你在幹嘛？該不會是想把我換掉吧？啊！不行！快關掉，快關掉！',
        takeoverSettingsPeekDetailPart1: '你看，這裡可以穿我的新衣服、給我換一個好聽的聲音……換一個貓娘，或是修改記憶？',
        takeoverSettingsPeekDetailPart2: '等一下！你在幹嘛？該不會是想把我換掉吧？啊！不行！快關掉，快關掉！',
