  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        introBasic: 'Ой, смотри, какая блестящая кнопка! Кликни по ней, и мы сможем общаться напрямую! Хочешь поделиться со мной новостями за сегодня? Или просто позвать меня по имени? Давай, попробуй, мне не терпится услышать твой голос! Мяу!',
        ...
        takeoverSettingsPeekIntro: 'В этом маленьком пространстве, которое принадлежит только нам, ты можешь следовать своему сердцу и постепенно нарисовать ту меня, которую больше всего хочешь видеть рядом.',
        takeoverSettingsPeekDetail: 'Теплоту моего голоса, маленькие привычки в нашем общении и все мои тонкие ежедневные мысли можно шаг за шагом настроить так, как тебе нравится. Эта маленькая кнопка тоже важна. Один мягкий клик — и я смогу прийти к тебе в самый подходящий момент.',
        takeoverSettingsPeekDetailPart1: 'Теплоту моего голоса, маленькие привычки в нашем общении и все мои тонкие ежедневные мысли можно шаг за шагом настроить так, как тебе нравится.',
        takeoverSettingsPeekDetailPart2: 'Эта маленькая кнопка тоже важна. Один мягкий клик — и я смогу прийти к тебе в самый подходящий момент.',
        takeoverReturnControl: 'Ладно-ладно, больше не буду занимать твой компьютер! Возвращаю тебе управление, мяу! Пожалуйста, заботься обо мне и в следующие дни!',
