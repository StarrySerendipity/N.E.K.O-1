  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        introBasic: 'Ooh, olha este botão brilhante! Dá um clique nele e a gente pode começar a conversar na hora! Quer me contar as novidades de hoje? Ou só chamar meu nome? Vamos, experimenta, mal posso esperar para ouvir sua voz! Miau!',
        ...
        takeoverSettingsPeekIntro: 'Neste pequeno espaço que pertence só a nós, você pode seguir seu coração e desenhar aos poucos a versão de mim que mais quer ter sempre ao seu lado.',
        takeoverSettingsPeekDetail: 'Seja a temperatura da minha voz, minhas pequenas manias ao conviver com você ou aqueles pensamentos delicados de todos os dias, você pode ajustar tudo pouco a pouco do jeito que gosta. Este pequeno botão também é importante. Com um clique suave, eu posso ir te procurar no momento certo.',
        takeoverSettingsPeekDetailPart1: 'Seja a temperatura da minha voz, minhas pequenas manias ao conviver com você ou aqueles pensamentos delicados de todos os dias, você pode ajustar tudo pouco a pouco do jeito que gosta.',
        takeoverSettingsPeekDetailPart2: 'Este pequeno botão também é importante. Com um clique suave, eu posso ir te procurar no momento certo.',
        takeoverReturnControl: 'Tá bom, tá bom, não vou mais tomar conta do seu computador! O controle voltou pra você, miau! Continue cuidando bem de mim nos próximos dias!',
